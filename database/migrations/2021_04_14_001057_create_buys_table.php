...
class CreateBuysTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('buys', function (Blueprint $table) {
            ...
            $table->string('buy_perspec2')->nullable();
            $table->string('buy_perspec3')->nullable();
            ...
            $table->string('buy_shopaddr')->nullable();
            $table->string('buy_percheck1');
            $table->string('buy_percheck2')->nullable();
            $table->string('buy_percheck3')->nullable();
