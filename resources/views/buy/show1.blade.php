            ...
            <div>
                <div class="card-body">
                    <div class="invoice">
                        ...
                        <p class="m-t-b-10">เรื่อง &nbsp;&nbsp;&nbsp;ขออนุมัติ ( ) ซื้อ (/) จ้าง ( ) เช่า <u class="dotted">{{ $buy->buy_header }}</u></p>
                            ...
                            <table class="table my-2 table-small table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-right">
                                        ...
                                        <td class="align-top text-left">รายละเอียดรายการจัดซื้อจัดจ้าง จำนวน {{ number_format($buyitem_count,0) }} รายการ
                                        <br><br>(รายละเอียดแนบท้ายบันทึก)
                                        </td>
                                        <td class="align-top">{{ number_format($buyitem_count,0) }} รายการ</td>
                                        <td class="align-top"></td>
                                        <td class="align-top"></td>
                                        <td class="align-top">{{ number_format($buysumprice,2) }}</td>
                                    </tr>
